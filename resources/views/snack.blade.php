    ...
    <div class="relative mt-20">
      <div class="absolute left-1/2 -translate-x-1/2">
        ...
        <div class="bg-[#FAEED1] skew-y-2 w-[230px] md:w-[380px] h-[100px] md:h-[140px] rotate-[4deg] rounded-md flex items-center justify-center">
          <h1 class="text-center -skew-y-2 text-[#607274] font-bold text-xl md:text-3xl -rotate-[4deg]">Snack in <br> Classic Charm Caffe</h1>
        </div>
      </div>
    </div>
    ...
    <div class="mt-80 grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 px-10 md:px-20 gap-7">
      <div class="flex flex-col px-10 gap-3">
        <div class="bg-[#B2A59B] rounded-full p-1 mx-auto">
          <img src="{{ asset('image/snack/bbq.jpg') }}" alt="gambar" class="h-[150px] rounded-full">
        </div>
        <div>
          <h5 class="text-[#607274] font-semibold text-lg">Crispy BBQ Chicken Wraps</h5>
      ...
      <div class="flex flex-col px-10 gap-3">
        <div class="bg-[#B2A59B] rounded-full p-1 mx-auto">
          <img src="{{ asset('image/snack/burger.jpg') }}" alt="gambar" class="h-[150px] rounded-full">
        </div>
        <div>
          <h5 class="text-[#607274] font-semibold text-lg">Burger</h5>
          <hr class="h-1 my-1 mx-auto bg-[#607274] border-0 rounded">
      ...
      <div class="flex flex-col px-10 gap-3">
        <div class="bg-[#B2A59B] p-1 rounded-full mx-auto">
          <img src="{{ asset('image/snack/dumplings.jpg') }}" alt="gambar" class="h-[150px] rounded-full">
        </div>
        <div>
          <h5 class="text-[#607274] font-semibold text-lg">Vegetable Potstickers</h5>
          <hr class="h-1 my-1 mx-auto bg-[#607274] border-0 rounded">
      ...
      <div class="flex flex-col px-10 gap-3">
        <div class="bg-[#B2A59B] p-1 rounded-full mx-auto">
          <img src="{{ asset('image/snack/lobster.jpg') }}" alt="gambar" class="h-[150px] rounded-full">
        </div>
        <div>
          <h5 class="text-[#607274] font-semibold text-lg">Mozzarella Sticks</h5>
          <hr class="h-1 my-1 mx-auto bg-[#607274] border-0 rounded">
          <p class="text-[#607274]">35.000</p>
        </div>
      </div>
      <div class="flex flex-col px-10 gap-3">
        <div class="bg-[#B2A59B] p-1 rounded-full mx-auto">
          <img src="{{ asset('image/snack/msticks.jpg') }}" alt="gambar" class="h-[150px] rounded-full">
        </div>
        <div>
          <h5 class="text-[#607274] font-semibold text-lg">Nachos</h5>
          <hr class="h-1 my-1 mx-auto bg-[#607274] border-0 rounded">
      ...
      <div class="flex flex-col px-10 gap-3">
        <div class="bg-[#B2A59B] p-1 rounded-full mx-auto">
          <img src="{{ asset('image/snack/nachos.jpg') }}" alt="gambar" class="h-[150px] rounded-full">
        </div>
        <div>
          <h5 class="text-[#607274] font-semibold text-lg">Spicy Shrimp Sushi </h5>
          <hr class="h-1 my-1 mx-auto bg-[#607274] border-0 rounded">
      ...
      <div class="flex flex-col px-10 gap-3">
        <div class="bg-[#B2A59B] p-1 rounded-full mx-auto">
          <img src="{{ asset('image/snack/sushi.jpg') }}" alt="gambar" class="h-[150px] w-28 rounded-full">
        </div>
        <div>
          <h5 class="text-[#607274] font-semibold text-lg">Spicy Shrimp Sushi </h5>
          <hr class="h-1 my-1 mx-auto bg-[#607274] border-0 rounded">
      ...
      <div class="flex flex-col px-10 gap-3">
        <div class="bg-[#B2A59B] p-1 rounded-full mx-auto">
         <img src="{{ asset('image/snack/potato.jpg') }}" alt="gambar" class="h-[150px] rounded-full">
        </div>
        <div>
          <h5 class="text-[#607274] font-semibold text-lg">Mini Lobster Rolls</h5>
          <hr class="h-1 my-1 mx-auto bg-[#607274] border-0 rounded">
      ...
      <div class="flex flex-col px-10 gap-3">
        <div class="bg-[#B2A59B] p-1 rounded-full mx-auto">
          <img src="{{ asset('image/snack/rings.jpg') }}" alt="gambar" class="h-[150px] rounded-full">
        </div>
        <div>
          <h5 class="text-[#607274] font-semibold text-lg">Onion Rings</h5>
          <hr class="h-1 my-1 mx-auto bg-[#607274] border-0 rounded">
          <p class="text-[#607274]">30.000</p>
        </div>
      </div>
