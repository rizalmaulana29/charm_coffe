    ...
    <div class="relative mt-20">
      <div class="absolute left-1/2 -translate-x-1/2">
        ...
        <div class="bg-[#FAEED1] skew-y-2 w-[230px] md:w-[380px] h-[100px] md:h-[140px] rotate-[4deg] rounded-md flex items-center justify-center">
          <h1 class="text-center -skew-y-2 text-[#607274] font-bold text-xl md:text-3xl -rotate-[4deg]">Main Course in <br> Classic Charm Caffe</h1>
        </div>
      </div>
    </div>
    ...
    <div class="mt-80 grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 px-10 md:px-20 gap-7">
      <div class="flex flex-col px-10 gap-3">
        <div class="bg-[#B2A59B] rounded-full p-1 mx-auto">
          <img src="{{ asset('image/maincourse/bokchoy.jpg') }}" alt="gambar" class="h-[150px] rounded-full">
        </div>
        <div>
          <h5 class="text-[#607274] font-semibold text-lg">Bok Choy and Mushroom Stir Fry</h5>
      ...
      <div class="flex flex-col px-10 gap-3">
        <div class="bg-[#B2A59B] rounded-full p-1 mx-auto">
          <img src="{{ asset('image/maincourse/bourguignon.jpg') }}" alt="gambar" class="h-[150px] rounded-full">
        </div>
        <div>
          <h5 class="text-[#607274] font-semibold text-lg">Vegan Mushroom Bourguignon</h5>
          <hr class="h-1 my-1 mx-auto bg-[#607274] border-0 rounded">
          <p class="text-[#607274]">90.000</p>
        </div>
      </div>
      <div class="flex flex-col px-10 gap-3">
        <div class="bg-[#B2A59B] p-1 rounded-full mx-auto">
          <img src="{{ asset('image/maincourse/marryme.jpg') }}" alt="gambar" class="h-[150px] rounded-full">
        </div>
        <div>
          <h5 class="text-[#607274] font-semibold text-lg">Marry Me Chicken</h5>
          <hr class="h-1 my-1 mx-auto bg-[#607274] border-0 rounded">
          <p class="text-[#607274]">65.000</p>
        </div>
      </div>
      <div class="flex flex-col px-10 gap-3">
        <div class="bg-[#B2A59B] p-1 rounded-full mx-auto">
          <img src="{{ asset('image/maincourse/meatballs.jpg') }}" alt="gambar" class="h-[150px] rounded-full">
        </div>
        <div>
          <h5 class="text-[#607274] font-semibold text-lg">Teriyaki Meatballs</h5>
          <hr class="h-1 my-1 mx-auto bg-[#607274] border-0 rounded">
      ...
      <div class="flex flex-col px-10 gap-3">
        <div class="bg-[#B2A59B] p-1 rounded-full mx-auto">
          <img src="{{ asset('image/maincourse/penne.jpg') }}" alt="gambar" class="h-[150px] rounded-full">
        </div>
        <div>
          <h5 class="text-[#607274] font-semibold text-lg">Creamy Penne Pasta</h5>
          <hr class="h-1 my-1 mx-auto bg-[#607274] border-0 rounded">
          <p class="text-[#607274]">50.000</p>
        </div>
      </div>
      <div class="flex flex-col px-10 gap-3">
        <div class="bg-[#B2A59B] p-1 rounded-full mx-auto">
          <img src="{{ asset('image/maincourse/scampi.jpg') }}" alt="gambar" class="h-[150px] rounded-full">
        </div>
        <div>
          <h5 class="text-[#607274] font-semibold text-lg">Shrimp Scampi Pasta</h5>
          <hr class="h-1 my-1 mx-auto bg-[#607274] border-0 rounded">
          <p class="text-[#607274]">80.000</p>
        </div>
      </div>
      <div class="flex flex-col px-10 gap-3">
        <div class="bg-[#B2A59B] p-1 rounded-full mx-auto">
          <img src="{{ asset('image/maincourse/schicken.jpg') }}" alt="gambar" class="h-[150px] w-28 rounded-full">
        </div>
        <div>
          <h5 class="text-[#607274] font-semibold text-lg">Roasted Spatchcock Chicken with Orange Rosemary</h5>
          <hr class="h-1 my-1 mx-auto bg-[#607274] border-0 rounded">
          <p class="text-[#607274]">85.000</p>
        </div>
      </div>
      <div class="flex flex-col px-10 gap-3">
        <div class="bg-[#B2A59B] p-1 rounded-full mx-auto">
         <img src="{{ asset('image/maincourse/skewers.jpg') }}" alt="gambar" class="h-[150px] rounded-full">
        </div>
        <div>
          <h5 class="text-[#607274] font-semibold text-lg">Grilled Chicken Skewers with Spicy Pesto</h5>
          <hr class="h-1 my-1 mx-auto bg-[#607274] border-0 rounded">
      ...
      <div class="flex flex-col px-10 gap-3">
        <div class="bg-[#B2A59B] p-1 rounded-full mx-auto">
          <img src="{{ asset('image/maincourse/teriyaki.jpg') }}" alt="gambar" class="h-[150px] rounded-full">
        </div>
        <div>
          <h5 class="text-[#607274] font-semibold text-lg">Teriyaki Chicken and Broccoli</h5>
          <hr class="h-1 my-1 mx-auto bg-[#607274] border-0 rounded">
