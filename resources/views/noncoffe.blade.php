    ...
    <div class="relative mt-20">
      <div class="absolute left-1/2 -translate-x-1/2">
        ...
        <div class="bg-[#FAEED1] skew-y-2 w-[230px] md:w-[380px] h-[100px] md:h-[140px] rotate-[4deg] rounded-md flex items-center justify-center">
          <h1 class="text-center -skew-y-2 text-[#607274] font-bold text-xl md:text-3xl -rotate-[4deg]">Non Coffe in <br> Classic Charm Caffe</h1>
        </div>
      </div>
    </div>
    ...
    <div class="mt-80 grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 px-10 md:px-20 gap-7">
      <div class="flex flex-col px-10 gap-3">
        <div class="bg-[#B2A59B] rounded-full p-1 mx-auto">
          <img src="{{ asset('image/drink/noncoffe/berry.jpg') }}" alt="gambar" class="h-[150px] rounded-full">
        </div>
        <div>
          <h5 class="text-[#607274] font-semibold text-lg">Berry Smoothie with Yogurt</h5>
      ...
      <div class="flex flex-col px-10 gap-3">
        <div class="bg-[#B2A59B] rounded-full p-1 mx-auto">
          <img src="{{ asset('image/drink/noncoffe/blue.jpg') }}" alt="gambar" class="h-[150px] rounded-full">
        </div>
        <div>
          <h5 class="text-[#607274] font-semibold text-lg">Blue Moon Milkshake</h5>
          <hr class="h-1 my-1 mx-auto bg-[#607274] border-0 rounded">
      ...
      <div class="flex flex-col px-10 gap-3">
        <div class="bg-[#B2A59B] p-1 rounded-full mx-auto">
          <img src="{{ asset('image/drink/noncoffe/caramel.jpg') }}" alt="gambar" class="h-[150px] rounded-full">
        </div>
        <div>
          <h5 class="text-[#607274] font-semibold text-lg">Caramel Apple Pie Milkshake</h5>
          <hr class="h-1 my-1 mx-auto bg-[#607274] border-0 rounded">
          <p class="text-[#607274]">30.000</p>
        </div>
      </div>
      <div class="flex flex-col px-10 gap-3">
        <div class="bg-[#B2A59B] p-1 rounded-full mx-auto">
          <img src="{{ asset('image/drink/noncoffe/chocolate.jpg') }}" alt="gambar" class="h-[150px] rounded-full">
        </div>
        <div>
          <h5 class="text-[#607274] font-semibold text-lg">Chocolate Milkshake</h5>
          <hr class="h-1 my-1 mx-auto bg-[#607274] border-0 rounded">
      ...
      <div class="flex flex-col px-10 gap-3">
        <div class="bg-[#B2A59B] p-1 rounded-full mx-auto">
          <img src="{{ asset('image/drink/noncoffe/cookie.jpg') }}" alt="gambar" class="h-[150px] rounded-full">
        </div>
        <div>
          <h5 class="text-[#607274] font-semibold text-lg">Cookie Milkshake</h5>
          <hr class="h-1 my-1 mx-auto bg-[#607274] border-0 rounded">
          <p class="text-[#607274]">30.000</p>
        </div>
      </div>
      <div class="flex flex-col px-10 gap-3">
        <div class="bg-[#B2A59B] p-1 rounded-full mx-auto">
          <img src="{{ asset('image/drink/noncoffe/mango.jpg') }}" alt="gambar" class="h-[150px] rounded-full">
        </div>
        <div>
          <h5 class="text-[#607274] font-semibold text-lg">Mango Matcha Latte</h5>
          <hr class="h-1 my-1 mx-auto bg-[#607274] border-0 rounded">
          <p class="text-[#607274]">35.000</p>
        </div>
      </div>
      <div class="flex flex-col px-10 gap-3">
        <div class="bg-[#B2A59B] p-1 rounded-full mx-auto">
          <img src="{{ asset('image/drink/noncoffe/matcha.jpg') }}" alt="gambar" class="h-[150px] w-28 rounded-full">
        </div>
        <div>
          <h5 class="text-[#607274] font-semibold text-lg">Matcha Milkshake</h5>
          <hr class="h-1 my-1 mx-auto bg-[#607274] border-0 rounded">
          <p class="text-[#607274]">30.000</p>
        </div>
      </div>
      <div class="flex flex-col px-10 gap-3">
        <div class="bg-[#B2A59B] p-1 rounded-full mx-auto">
         <img src="{{ asset('image/drink/noncoffe/pumpkin.jpg') }}" alt="gambar" class="h-[150px] rounded-full">
        </div>
        <div>
          <h5 class="text-[#607274] font-semibold text-lg">Pumpkin Spice Milkshake</h5>
          <hr class="h-1 my-1 mx-auto bg-[#607274] border-0 rounded">
      ...
      <div class="flex flex-col px-10 gap-3">
        <div class="bg-[#B2A59B] p-1 rounded-full mx-auto">
          <img src="{{ asset('image/drink/noncoffe/raspberry.jpg') }}" alt="gambar" class="h-[150px] rounded-full">
        </div>
        <div>
          <h5 class="text-[#607274] font-semibold text-lg">Raspberry Banana Smoothie</h5>
          <hr class="h-1 my-1 mx-auto bg-[#607274] border-0 rounded">
          <p class="text-[#607274]">30.000</p>
        </div>
      </div>
