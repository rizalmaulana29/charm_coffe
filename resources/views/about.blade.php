...
<body class="bg-[#FAEED1]">
    ...
    <main class="px-10 md:px-24 my-32 flex items-center justify-center flex-col gap-5">
        <div class="bg-[#DED0B6] py-10 md:py-20  px-10 md:px-20 rounded-3xl w-full max-w-3xl">
            <h1 class="text-center font-bold text-4xl md:text-6xl text-[#607274] mb-5">About Us</h1>
            <p class="text-[#607274] text-xl md:text-4xl text-center md:text-justify">Classic Charm Caffe menyediakan suatu hidangan makanan dan minuman yang ditampilkan dalam bentuk website menu. </p>
        </div>
        <div>
          <a href="/menu/team">
            <button type="button" class="text-white mr-2 bg-[#DED0B6] hover:bg-[#607274] font-medium rounded-lg text-base px-5 py-2.5 text-center inline-flex items-center ">
